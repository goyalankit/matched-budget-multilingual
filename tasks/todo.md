...
- [ ] §14 registration fields all filled from configs (no placeholders)
- [ ] OSF registration filed (with review rounds + memos as supplements)
- [ ] GATE: no study generation before registration is filed
...
- [ ] If any cell >10% failures: governed fix + OSF amendment + discard/rerun affected pilot gens
